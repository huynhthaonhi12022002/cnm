        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#apply_job"><i class="fa fa-plus"></i> Add Job</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
					...
					<div class="alert alert-info alert-dismissible fade show" role="alert" id="download-alert" style="display: none;">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped custom-table datatable">
                                    ...
                                    if(isset($_GET["id"])) {
                                        $id =  $_GET["id"];
                                        $results = $applicantObj->viewApplicantById($id);
                                    }
									...
									?>
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-danger" href="#" data-toggle="modal" data-target="#delete_applicant_<?=$row["id"]?>"><i class="fa fa-trash-o "></i></a>
											</td>
										</tr>
                                        <div class="modal custom-modal fade" id="delete_applicant_<?=$row["id"]?>" role="dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modal-btn delete-action">
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <a href="job-applicants.php?delid=<?=$row["id"]?>" class="btn btn-primary continue-btn">Delete</a>
                                                                </div>
                                                                <div class="col-6">
