										...
										<tr>
											...
											<td>
												<h2 class="table-avatar">
													<a href="client-profile.php" class="avatar"><img src="upload/clients/<?php echo htmlentities($row["avatar"]); ?>" alt=""></a>
											...
											<td class="text-center">
												<a class="btn btn-warning editbtn" href="#" data-toggle="modal" data-target="#edit_client" data-id="<?=$row["id"]?>" data-address="<?=$row["address"]?>" data-avatar="<?=$row["avatar"]?>"
												data-firstname="<?=$row["firstname"]?>" data-lastname="<?=$row["lastname"]?>" data-phone="<?=$row["phone"]?>" data-email="<?=$row["email"]?>" data-company="<?=$row["company"]?>"><i class="fa fa-pencil "></i> </a>
												<a class="btn btn-danger" href="#" data-toggle="modal" data-target="#delete_client_<?=$row["id"]?>"><i class="fa fa-trash-o "></i> </a>
											</td>
										</tr>
