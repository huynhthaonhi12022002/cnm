...
$result_dashboard = $dashboard->getEmployeeDashboardSummary($_SESSION['employee_id']);
$result_count_pro = $dashboard->getEmployeeProjectCount($_SESSION['employee_id']);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
						...
						<div class="col-md-12">
							<div class="welcome-box">
								...
								<div class="welcome-det">
									<h3>Welcome, <?=$_SESSION['userlogin']?></h3>
									<p><?php date_default_timezone_set("Asia/Ho_Chi_Minh");
   echo date("h:i:s d-m-Y"); ?></p>
								</div>
							</div>
						</div>
					</div>
										...
										<div class="card-body">
											<div class="time-list">
												<div class="dash-stats-list">
													<h4><?=$result_dashboard['total_tasks'] ?? 0?></h4>
													<p>Tổng nhiệm vụ</p>
												</div>
												<div class="dash-stats-list">
													<h4><?=$result_dashboard['pending_tasks'] ?? 0?></h4>
													<p>Nhiệm vụ đang thực hiện</p>
												</div>
											</div>
											<div class="request-btn">
												<div class="dash-stats-list">
													<h4><?=$result_count_pro ?? 0?></h4>
													<p>Tổng dự án tham gia</p>
												</div>
											</div>
										</div>
									</div>
								...
								<section>
									...
									<div class="card">
										<div class="card-body">
											...
											<div class="request-btn">
												<a class="btn btn-primary" href="leave-employee.php">Apply Leave</a>
											</div>
										</div>
									</div>
								</section>
