...
if (strlen($_SESSION["userlogin"]) == 0 && $_SESSION["user_role"] == 1 || strlen($_SESSION["userlogin"]) == 0 && $_SESSION["user_role"] == 0 ) {
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <nav class="greedy">
                        <ul class="link-item">
                            <li>
                                <a href="index.php"><i class="fa-solid fa-arrow-left"></i><span>Back to Home</span></a>
                            </li>
